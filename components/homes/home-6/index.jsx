        ...
        <div className="container position-relative">
          <div className="row mb-xs-40">
            <div className="col-md-10 offset-md-1 col-lg-8 offset-lg-2 text-center">
              ...
              >
                Revive Kindness is dedicated to nurturing mindfulness,
                compassion, empathy, and emotional intelligence through
                interactive programs and engaging content. We believe that
                mindfulness is the foundation for self-awareness and empathy,
                enabling small acts of kindness to ripple into transformative
                changes, creating a more harmonious and compassionate world.
              </p>
