    ...
    <div className="container position-relative">
      <div className="row">
        ...
        <div className="col-lg-4 mb-md-50 mb-sm-30 position-relative z-index-1">
          <h2 className="section-caption-fancy mb-20 mb-xs-10" style={{ color: "#FB9533" }}>Contact Us</h2>
            ...
            <div className="col-md-11">
              ...
              {contactItems.map((item, index) => (
                <React.Fragment key={index}>
                  ...
                  >
                    <div className="ci-icon" style={{ color: "#FB9533" }}>
                  ...
                  <div className="col-md-6 col-xl-5">
                    ...
                    <div className="pt-3">
                      <button
                        ...
                        id="submit_btn"
                        aria-controls="result"  style={{ backgroundColor: "#FB9533", color: "#FFFFFF" }}
