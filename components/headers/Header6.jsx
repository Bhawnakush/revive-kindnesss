...
import LanguageSelect from "./components/LanguageSelect";//selct service
    ...
    <div className="main-nav-sub container">
      ...
      <div className="nav-logo-wrap position-static local-scroll">
        <a href="#top" className="logo">
          <Image
            src="/assets/images/demo-fancy/Revive-Kindness-Logo.svg"
              ...
              >
                ...
                >
                  <span className="btn-animate-y">
                    <span className="btn-animate-y-1" style={{ color: "#FB9533" }}>Get in touch</span>
                    <span className="btn-animate-y-2" aria-hidden="true" style={{ color: "#FB9533" }}>
                      Get in touch
                    </span>
                  </span>
                </span>
