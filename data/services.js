...
export const services3 = [
  {
    ...
    text: `Program 1: Classroom Training
  Interactive, hands-on training sessions designed to cultivate mindfulness, empathy, and kindness in schools and workplaces. Participants will learn practical tools for enhancing emotional intelligence and fostering meaningful connections.
  CTA: Learn More (Simple email inquiry form)`,
  }
,  
  {
    src: "/assets/images/demo-fancy/services/service-2.png",
    title: " Mindfulness & Kindness Video Lessons",
    text: `Engaging, short-format videos designed to make mindfulness and kindness a habit in everyday life. Perfect for self-paced learning, these lessons guide individuals on practicing gratitude, staying present, and building empathy in interactions.
CTA: Get Started (Enquiry Form)
`,
  },
  {
    src: "/assets/images/demo-fancy/services/service-3.png",
    title: "Social Media Content",
    text: `Inspiring daily content on mindfulness, empathy, and kindness through Facebook, Instagram, and LinkedIn. Follow us for tips, affirmations, and stories that reinforce mindful living and compassionate connections.
CTA: Subscribe (Inquiry Form + Social Handles to Join for Free)
